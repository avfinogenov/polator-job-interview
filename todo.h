...
// разделить воркинг виз сенсор на 3 стейта - авайтинг инпут, процесс сенсор дата, процес р2 дата
// сделать ограничения по стейтам, чтобы в одном из стейтов нельзя было делать действия других стейтов
