...
// просто объект, который ловит сигналы, почему то сам в себя кидать сигналы не хотел, выяснять почему не стал
...
// развязка для совмещения QObject и темплейтов
...
public:
    ...
    explicit IOT(QString inputName, QObject *parent = nullptr):
                QObject(parent)
    {
...
template <typename BackendT, typename R2ConnectionParamsT,
          typename GEOT, typename TokenT>
IOTF<BackendT, R2ConnectionParamsT, GEOT, TokenT>::IOTF(Radio2ChannelF<R2ConnectionParamsT, TokenT>* channel,
             R2ConnectionParamsT myR2Info, BackendT backendConnectionParams,
             BackendF<BackendT, R2ConnectionParamsT, GEOT>* backend, QString inputName):
...
template <typename BackendT, typename R2ConnectionParamsT,
          typename GEOT, typename TokenT>
void IOTF<BackendT, R2ConnectionParamsT, GEOT, TokenT>::process()
{
...
template <typename BackendT, typename R2ConnectionParamsT,
          typename GEOT, typename TokenT>
void IOTF<BackendT, R2ConnectionParamsT, GEOT, TokenT>::propagate()
{
...
template <typename BackendT, typename R2ConnectionParamsT,
          typename GEOT, typename TokenT>
void IOTF<BackendT, R2ConnectionParamsT, GEOT, TokenT>::sync()
{
    m_radio1.connect();
...
template <typename BackendT, typename R2ConnectionParamsT,
          typename GEOT, typename TokenT>
void IOTF<BackendT, R2ConnectionParamsT, GEOT, TokenT>::stateEntered()
{
    qInfo() << m_selfName;
...
template <typename BackendT, typename R2ConnectionParamsT,
          typename GEOT, typename TokenT>
void IOTF<BackendT, R2ConnectionParamsT, GEOT, TokenT>::debugInfo()
{
